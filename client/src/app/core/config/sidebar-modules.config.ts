...
export const GROUP_TO_MODULES: Record<string, SidebarModuleKey[]> = {
  ...
  'Departamento Visión Juvenil': [SIDEBAR_MODULES.dashboard, SIDEBAR_MODULES.eventos, SIDEBAR_MODULES.visitantes, SIDEBAR_MODULES.biblia, SIDEBAR_MODULES.deptVisionJuvenil],
  'Departamento Adoremos': [SIDEBAR_MODULES.dashboard, SIDEBAR_MODULES.eventos, SIDEBAR_MODULES.visitantes, SIDEBAR_MODULES.biblia, SIDEBAR_MODULES.deptAdoremos],
  'Departamento Escuela de Formación': [SIDEBAR_MODULES.dashboard, SIDEBAR_MODULES.eventos, SIDEBAR_MODULES.visitantes, SIDEBAR_MODULES.biblia, SIDEBAR_MODULES.deptEscuelaFormacion],
  ...
  'Departamento Salvación': [SIDEBAR_MODULES.dashboard, SIDEBAR_MODULES.eventos, SIDEBAR_MODULES.visitantes, SIDEBAR_MODULES.biblia, SIDEBAR_MODULES.deptSalvacion],
  'Departamento Audiovisuales': [SIDEBAR_MODULES.dashboard, SIDEBAR_MODULES.eventos, SIDEBAR_MODULES.visitantes, SIDEBAR_MODULES.biblia, SIDEBAR_MODULES.deptAudiovisuales],
  'Departamento Mujeres que Reinan': [SIDEBAR_MODULES.dashboard, SIDEBAR_MODULES.eventos, SIDEBAR_MODULES.visitantes, SIDEBAR_MODULES.biblia, SIDEBAR_MODULES.deptMujeresReinan],
  'Departamento Varones Amigos de Dios': [SIDEBAR_MODULES.dashboard, SIDEBAR_MODULES.eventos, SIDEBAR_MODULES.visitantes, SIDEBAR_MODULES.biblia, SIDEBAR_MODULES.deptVaronesAmigosDios],
  'Departamento Danza Kadosh': [SIDEBAR_MODULES.dashboard, SIDEBAR_MODULES.eventos, SIDEBAR_MODULES.visitantes, SIDEBAR_MODULES.biblia, SIDEBAR_MODULES.deptDanzaKadosh],
  'Departamento Intercesión': [SIDEBAR_MODULES.dashboard, SIDEBAR_MODULES.eventos, SIDEBAR_MODULES.visitantes, SIDEBAR_MODULES.biblia, SIDEBAR_MODULES.deptIntercesion],
  'Departamento Entrelazados': [SIDEBAR_MODULES.dashboard, SIDEBAR_MODULES.eventos, SIDEBAR_MODULES.visitantes, SIDEBAR_MODULES.biblia, SIDEBAR_MODULES.deptEntrelazados],
  'Departamento Protocolo': [SIDEBAR_MODULES.dashboard, SIDEBAR_MODULES.eventos, SIDEBAR_MODULES.visitantes, SIDEBAR_MODULES.biblia, SIDEBAR_MODULES.deptProtocolo],
};
